...
class Regexes(object):
    ...
    linename_pattern = re.compile('(?P<operator>^([\d]+_|MUN|EBA|PRES|SFS|PM))(?P<line>[a-zA-Z0-9/_.]+?)((?P<direction>WB|SB|NB|EB|I|O)?(?P<agency_short>ACE|VTA|AC|MUN|NAP|WC|GG)?(?P<reverse_flag>_R)?)$')
